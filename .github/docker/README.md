...
To build for a specific model (e.g., `stretch-se4-0001`):
```bash
./.github/docker/build.sh -f stretch-se4-0001
```

To build with a custom image name:
```bash
./.github/docker/build.sh -f stretch-se4-0001 -n custom-stretch-test
```
...
```bash
./.github/docker/test.sh -i stretch-install:stretch-se4-0000
```

To test a custom-named image:
```bash
./.github/docker/test.sh -i custom-stretch-test:stretch-se4-0001
```
